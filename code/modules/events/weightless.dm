...
/datum/round_event/weightless
	...
	var/list/obj/machinery/gravity_generator/activeGens = list()
	var/obj/machinery/gravity_generator/active
...
/datum/round_event/weightless/start()
	for(var/obj/machinery/gravity_generator/G in machines)
