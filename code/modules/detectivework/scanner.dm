...
/obj/item/device/detective_scanner/budget
	name = "Nanotrasen-brand forensic scanner"
	desc = "Used to remotely scan objects and biomass for DNA and fingerprints. Can print a report of the findings. This model is a bit dodgy."
...
/obj/item/device/detective_scanner/budget/scan(var/atom/A, var/mob/user)
