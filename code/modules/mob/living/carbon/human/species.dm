...
/datum/species
	...
	proc/update_base_icon_state(var/mob/living/carbon/human/H)
	...
	proc/handle_hair(var/mob/living/carbon/human/H)
	...
	proc/handle_body(var/mob/living/carbon/human/H)
	...
	proc/spec_life(var/mob/living/carbon/human/H)
		return

	proc/spec_death(var/gibbed, var/mob/living/carbon/human/H)
		return

	proc/auto_equip(var/mob/living/carbon/human/H)
		// handles the equipping of species-specific gear
		return

	proc/can_equip(var/obj/item/I, var/slot, var/disable_warning, var/mob/living/carbon/human/H)
		if(slot in no_equip)
	...
	proc/handle_chemicals_in_body(var/mob/living/carbon/human/H)
	...
	proc/handle_vision(var/mob/living/carbon/human/H)
		if( H.stat == DEAD )
...
//				else									rest.icon_state = "rest0"
	...
	proc/handle_mutations_and_radiation(var/mob/living/carbon/human/H)
		if(H.getFireLoss())
	...
	proc/movement_delay(var/mob/living/carbon/human/H)
		var/mspeed = 0
	...
	proc/spec_attacked_by(var/obj/item/I, var/mob/living/user, var/def_zone, var/obj/item/organ/limb/affecting, var/hit_area, var/intent, var/obj/item/organ/limb/target_limb, target_area, var/mob/living/carbon/human/H)
	...
	proc/attacked_by(var/obj/item/I, var/mob/living/user, var/def_zone, var/mob/living/carbon/human/H)
	...
	proc/breathe(var/mob/living/carbon/human/H)
	...
	proc/handle_breath(datum/gas_mixture/breath, var/mob/living/carbon/human/H)
	...
	proc/handle_temperature(datum/gas_mixture/breath, var/mob/living/carbon/human/H) // called by human/life, handles temperatures
	...
	proc/handle_environment(datum/gas_mixture/environment, var/mob/living/carbon/human/H)
		if(!environment)
			return
	...
	proc/IgniteMob(var/mob/living/carbon/human/H)
