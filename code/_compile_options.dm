...
#define AGE_MAX				999	//oldest a character can be
...
#define THIRST_FACTOR		0.1 // SHINE determines how fast mob gets thirsty
...
//#define AI_VOX 1 // Comment out if you don't want VOX to be enabled and have players download the voice sounds. // SHINE removed because we dont use AI
